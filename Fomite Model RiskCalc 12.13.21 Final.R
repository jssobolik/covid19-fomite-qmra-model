...
### Fomite-mediated transmission model
...
source("C:\\Users\\Fomite Model QMRAFunctions 12.13.21 Final.R")
...
i.Clean7<-0
i.Clean8<-0
i.index.mask<-"surgical"
i.susceptible.mask<-"surgical"
i.HW<-"no"
i.Glove<-"no"
...
write.csv(riskaero.comb.stats, "C:\\Users\\Desktop\\aeroriskfomite.csv", row.names=TRUE)
...
write.csv(risk1m.comb.stats, "C:\\Users\\Desktop\\risk1mfomite.csv", row.names=TRUE)
...
write.csv(fconc1mcomb, "C:\\Users\\Desktop\\fomiteconcentration1m.csv", row.names=TRUE)
